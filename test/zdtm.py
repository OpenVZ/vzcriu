    ...
    def blocking(self, action):
        ...
        if action == None:
            return (test_flag(self.__desc, 'crfail')
                    or self.blocking_dump()
                    or self.blocking_restore())
...
class Launcher:
    ...
    def run_test(self, name, desc, flavor):
        ...
        nd = ('nocr', 'norst', 'pre', 'iters', 'page_server', 'sibling',
              ...
              'tls', 'criu_bin', 'crit_bin', 'pre_dump_mode', 'mounts_compat')
...
rp.add_argument("--pre-dump-mode",
                ...
                choices=['splice', 'read'],
                default='splice')
rp.add_argument("--mounts-compat",
                help="Use old mounts restore engine",
                action='store_true')
