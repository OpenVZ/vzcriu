...
extern void add_child_task(struct pstree_item *child, struct pstree_item *parent);
...
extern struct pstree_item *pssubtree_item_next(struct pstree_item *item, struct pstree_item *root,
